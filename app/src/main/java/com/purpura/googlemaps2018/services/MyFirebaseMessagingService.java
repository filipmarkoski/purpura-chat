package com.purpura.googlemaps2018.services;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void sendChatMessage(ChatMessage chatMessage) {
        if (FirebaseMessaging.getInstance().isAutoInitEnabled()) {
            ...
            String userId = chatMessage.getUser().getUser_id();
            ...
            } else if (chatMessage.hasImageUrl()) {
                String message = String.format("%s has sent an image", user.getUsername());
            ...
            if (remoteMessage != null) {
                ...
                Log.e(TAG, "sendChatMessage: ", new NullPointerException());
            }
